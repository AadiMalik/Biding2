		...
		<div class="container">
			<div class="d-flex justify-content-between align-items-center">
				<div class="d-flex">
							...
							<div class="offcanvas-body p-0">
								<div>
									<a class="nav-link active" aria-current="page" href="{{url('/')}}"><i
											class="fas fa-th"></i>
										Home</a>
									<a class="nav-link" href="#"> <i class="fas fa-trophy "></i>SUBASTAS CERRADAS</a>
									<a class="nav-link" href="#"><i class="fas fa-shopping-bag"></i> OPINIONES</a>
									<a class="nav-link" href="#"> <i class="fas fa-play-circle"></i>CÓMO FUNCIONA</a>
										CÓMO FUNCIONA
					...
					<a class="navbar_brand" href="{{url('/')}}"><img src="{{asset('assets/images/Logo subastek sin fondo.png')}}" alt=""></a>
				</div>
